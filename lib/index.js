          ...
          if (state.opts.exactGlobals) {
            ...
            if (globalName) {
              if (globalName.indexOf(".") > -1) {
                ...
                var namespacedProperties = members.slice(1).reduce(function (accum, curr, index) {
                  var prerequisiteAssignment = buildPrerequisiteAssignment({ GLOBAL_REFERENCE: accum[index] });
